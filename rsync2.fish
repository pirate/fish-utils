function rsync2
	command rsync -zrPhl --progress --size-only --exclude='*.pyc' --exclude='site-packages' --exclude='machine_id.py' --exclude='*.sql.gz' --exclude='.git*' --exclude='sandbox' /Users/nick/drchrono-web/ drstaff:/home/nikisweeting/drchrono-web
