    ...
    if test (count $argv) -gt 0
        switch $argv[1]
            case 'install'
                ...
                echoblue "[+] Trying Pip (2.7):"; pip install $argv[2..-1]; and echoblue "[√] Install succeeded using pip"; and return;
            ...
            case 'remove'
                ...
                echoblue "[+] Trying Pip (2.7):"; pip uninstall $argv[2..-1]; and echoblue "[√] Removed package using pip"; and return;
                echoblue "[?] Try using gem & npm?"; read_confirm; or return;
            ...
            case 'update'
                ...
                echoblue "[+] Trying Pip (2.7):"; pip install --upgrade pip; and echoblue "[√] Updated pip";
            ...
            case 'upgrade'
                ...
                echoblue "[+] Trying Pip (2.7):"; pip install --upgrade $argv[2..-1]; and echoblue "[√] Upgraded package using pip"; and return;
                echoblue "[?] Try using gem & npm?"; read_confirm; or return;
