function deploy --description 'Deploy current branch to the grater server'
    ...
    echo $blue"[↓] Pulling"$normal" origin/live to grater.sweeting.me"
    ssh grater "git remote update; \
                git branch -D temp -q; \
    ...
    ssh grater "killall python; \
              cd grater-django/;
              nohup ./manage.py runserver > /var/log/grater.log 2>&1 & \
              service nginx reload;"

    echo $green"[√] Done!"$normal" Visit https://grater.sweeting.me"$normal
